> [!WARNING]  
> recently discord has been rolling out a new UI refresh update to some users, which breaks the theme. if you have this update, please join the [discord server](https://discord.gg/nz87hXyvcy) for instructions on how to revert the update.
